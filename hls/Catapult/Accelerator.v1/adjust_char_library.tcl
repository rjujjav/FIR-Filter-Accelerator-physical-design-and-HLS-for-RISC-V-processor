...
#library load /mnt/coe/workspace/ece/ece720-common/tools/catapult2021.1/Mgc_home/pkgs/siflibs/nangate/nangate-45nm_beh.lib
library set /LIBS/nangate-45nm_beh/MODS/mgc_add/PARAMETERS/width_b -- -CHAR_RANGE {1, 2 to 2, 4 to 24, 32 to 32, 64 to 64}
library set /LIBS/nangate-45nm_beh/MODS/mgc_nor/PARAMETERS/ninps -- -CHAR_RANGE {2 to 2, 4 to 32, 64}
...
library set /LIBS/nangate-45nm_beh/MODS/mgc_shift_l/PARAMETERS/width_z -- -CHAR_RANGE {4 to 4, 8 to 8, 16 to 16, 32 to 32, 64}
library set /LIBS/nangate-45nm_beh/MODS/mgc_shift_bl/PARAMETERS/width_s -- -CHAR_RANGE {1 to 1, 3 to 6 by 1, 7}
library set /LIBS/nangate-45nm_beh/MODS/mgc_shift_bl/PARAMETERS/width_z -- -CHAR_RANGE {4 to 4, 8 to 8, 16 to 16, 32 to 32, 64}
